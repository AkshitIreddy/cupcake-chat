...
`node scripts/package-sidecars.mjs` builds the Python runtime with PyInstaller, builds the Rust
ToolBroker, verifies the pinned no-weights Cupcake Local CPU baseline and signed installable-model
catalog, and atomically stages:
