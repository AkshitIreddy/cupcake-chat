...
pub fn install(app: &App) -> tauri::Result<()> {
    let open = MenuItem::with_id(app, "open", "Open Cupcake Chat", true, None::<&str>)?;
    ...
    let about = MenuItem::with_id(app, "app.about", "About Cupcake Chat", true, None::<&str>)?;
