...
| llama.cpp CUDA 12         | Same managed llama.cpp surface. NVIDIA lists CUDA 12.x minor-version compatibility in the 525–579 driver family; newer drivers remain supported through backward compatibility.                                                      | Retain as a signed fallback for older supported drivers and for CUDA 13 regressions.                                                                                  |
